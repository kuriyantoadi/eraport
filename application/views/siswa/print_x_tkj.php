                ...
                <!-- <table class="table table-bordered"> -->
                    <div class="bordered">
                        <table style="margin-bottom: 20px;">
                            ...
                            <tr>
                                <th>1</th>
                                <td>Teknologi Berbasis Luas (WAN)</td>
                                <td align='center'><?= $row->tjbl_wan_p ?></td>
                                <td align='center'><?= $row->tjbl_wan_k ?></td>
                                <td align='center'><?= $row->tjbl_wan_na ?></td>
                                <td align='center'><?= $row->tjbl_wan_pr ?></td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <td>Administrasi Infrastruktur Jaringan</td>
                                <td align='center'><?= $row->aij_p ?></td>
                                <td align='center'><?= $row->aij_k ?></td>
                                <td align='center'><?= $row->aij_na ?></td>
                                <td align='center'><?= $row->aij_pr ?></td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <td>Administrasi Sistem Jaringan</td>
                                <td align='center'><?= $row->asj_p ?></td>
                                <td align='center'><?= $row->asj_k ?></td>
                                <td align='center'><?= $row->asj_na ?></td>
                                <td align='center'><?= $row->asj_pr ?></td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <td>Teknologi Layanan Jaringan</td>
                                <td align='center'><?= $row->tlj_p ?></td>
                                <td align='center'><?= $row->tlj_k ?></td>
                                <td align='center'><?= $row->tlj_na ?></td>
                                <td align='center'><?= $row->tlj_pr ?></td>
                            </tr>
                            <tr>
                                <th>5</th>
