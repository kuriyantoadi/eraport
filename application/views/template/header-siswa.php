...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?= base_url() ?>C_siswa/dashboard" class="navbar-brand">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>C_siswa/profil" class="nav-link">Profil Siswa</a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url() ?>C_siswa/print_x_akl" class="nav-link">Raport</a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url() ?>C_siswa/password" class="nav-link">Password</a>
          </li>
        </ul>
      </div>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        <li class="nav-item">
          <a href="<?= base_url() ?>C_login/siswa_logout" class="nav-link">Keluar</a>
        </li>
