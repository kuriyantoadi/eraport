              ...
              <div class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control" id="inputEmail3" name="id_kelas" value="<?= $row->id_kelas ?>" placeholder="Nama Kelas" required>
                      <input type="text" class="form-control" id="inputEmail3" name="nama_kelas" value="<?= $row->nama_kelas ?>" placeholder="Nama Kelas" required>
                    </div>
                  </div>
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Program Keahlian</label>
                      <div class="col-sm-10">
                        <select name="program_keahlian" class="form-control " style="width: 100%;" required>
                          <option value="<?= $row->program_keahlian ?>">Pilihan Awal | <?= $row->program_keahlian ?></option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select name="tingkat" class="form-control " style="width: 100%;" required>
                        <option value="<?= $row->tingkat ?>">Pilihan Awal | <?= $row->tingkat ?></option>
